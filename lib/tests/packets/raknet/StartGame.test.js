...
describe('StartGame', () => {
    it('encodes & decodes correctly', () => {
        ...
        const encoded = new StartGame_1.StartGame(props).encode();
        const decoded = new StartGame_1.StartGame().parse(encoded.clone()).props;
        ...
        expect(decoded.spawnLocation).toEqual(new math3d_1.Vector3(5, 5, 5));
        ...
        expect(decoded.gameRules).toEqual([{ name: 'naturalregeneration', type: world_1.GameRuleType.BOOL, value: false }]);
